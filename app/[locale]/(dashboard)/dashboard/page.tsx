...
import { GraduationIcon } from "@/lib/CSVG";
        ...
        <section className="w-full space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="space-y-1 pt-1 pl-1">
                    <div className="flex items-center gap-2 text-muted-foreground font-semibold text-lg md:text-xl">
                        <GraduationIcon className="text-muted-foreground" />
                        ...
                        {stats.map((stat) => {
                            return (
                                <motion.div
                                    key={stat.id}
                                    whileHover={{ y: -2 }}
                                    className="px-4 py-2.5 rounded-xl border border-border bg-card text-card-foreground shadow-2xs flex flex-col items-center justify-center min-w-22 sm:min-w-24 gap-1"
                                >
