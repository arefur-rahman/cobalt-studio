...
export default function EditArticleClient({ article }: EditArticleClientProps) {
    ...
    // SEO & Social sharing states (pre-populated from article)
    const [metaTitleEn, setMetaTitleEn] = useState(article.metaTitleEn || "");
    const [metaTitleBn, setMetaTitleBn] = useState(article.metaTitleBn || "");
    ...
    const [noIndex, setNoIndex] = useState(Boolean(article.noIndex));
        ...
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            ...
            <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-zinc-50/50 dark:bg-zinc-900/30 border border-zinc-200/80 dark:border-zinc-800/80 rounded-2xl overflow-hidden transition-all">
                        <button
                            type="button"
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-400">
                                        ...
                                        keywords, OpenGraph card images, and
                                        indexing.
                                    </p>
                                </div>
                            </div>
                        ...
                        {isSeoOpen && (
                            <div className="p-6 border-t border-zinc-200 dark:border-zinc-800 space-y-6 bg-white dark:bg-zinc-950/40">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span
                                                className={`text-[11px] font-mono ${metaTitleEn.length > 60 ? "text-amber-500 font-bold" : "text-zinc-400"}`}
                                            >
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span
                                                className={`text-[11px] font-mono ${metaTitleBn.length > 60 ? "text-amber-500 font-bold" : "text-zinc-400"}`}
                                            >
                                                {metaTitleBn.length}/60 chars{" "}
                                                {metaTitleBn.length > 60 &&
                                                    "(warn: >60)"}
                                            </span>
                                        </div>
                                        <input
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span
                                                className={`text-[11px] font-mono ${metaDescriptionEn.length > 160 ? "text-amber-500 font-bold" : "text-zinc-400"}`}
                                            >
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span
                                                className={`text-[11px] font-mono ${metaDescriptionBn.length > 160 ? "text-amber-500 font-bold" : "text-zinc-400"}`}
                                            >
                                                {metaDescriptionBn.length}/160
                                                chars{" "}
                                                {metaDescriptionBn.length >
                                                    160 && "(warn: >160)"}
                                            </span>
                                        </div>
                                        <textarea
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-2">
                                            <IconTag className="h-3.5 w-3.5 text-primary" />{" "}
                                            Keywords / Meta Tags (English)
                                        </label>
                                        <input
                                            type="text"
                                            value={keywordsEn}
                                            onChange={(e) =>
                                                setKeywordsEn(e.target.value)
                                            }
                                    ...
                                    <div>
                                        <label className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-2">
                                            <IconTag className="h-3.5 w-3.5 text-primary" />{" "}
                                            Keywords / Meta Tags (Bangla)
                                        </label>
                                        <input
                                            type="text"
                                            value={keywordsBn}
                                            onChange={(e) =>
                                                setKeywordsBn(e.target.value)
                                            }
                                            placeholder="সিস্টেম ডিজাইন, ডাটাবেস, ক্যাশিং"
                                            className="w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:border-primary transition-all"
                                        />
                                        <p className="mt-1 text-[11px] text-zinc-400">
                                            কমা দ্বারা বিভক্ত ট্যাগ।
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-2">
                                            <IconLink className="h-3.5 w-3.5 text-primary" />{" "}
                                        ...
                                        />
                                        <p className="mt-1 text-[11px] text-zinc-400">
                                            Optional. Use if republished from
                                            another domain.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800">
                                    <div>
                                        ...
                                        <p className="text-[11px] text-zinc-400">
                                            If enabled, search engines will be
                                            instructed not to index this article
                                            or show it in search results.
                                        </p>
                                    </div>
